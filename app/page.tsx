...
import { Brain, GraduationCap, LineChart, ShieldAlert, Sparkles, BookOpen, Building2, ArrowRight } from "lucide-react";
        ...
        <div className="mx-auto flex max-w-7xl flex-col px-6 pb-20 pt-8 sm:px-8 lg:px-12">
          <header className="mb-16 flex items-center justify-between rounded-full border border-white/60 bg-white/70 px-5 py-3 shadow-sm backdrop-blur">
            <div className="flex items-center gap-3">
              ...
              <div>
                <p className="text-sm font-semibold tracking-wide text-slate-900">AI-Driven LMS</p>
                <p className="text-xs text-slate-500">Personalized learning, reimagined</p>
              </div>
            </div>
